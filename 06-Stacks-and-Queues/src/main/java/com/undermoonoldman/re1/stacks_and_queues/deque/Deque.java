package com.undermoonoldman.re1.stacks_and_queues.deque;

/**
 * @author arthurmeng
 * 双端队列,没有一个额外空间的浪费
 * 与普通的队列相比，可以头插也可以尾插，删除操作也同时可以在头尾进行
 */
public class Deque<E> {
    ...
    /***
     * javadoc
     * 方便起见，我们的 Deque 实现，将使用 size 记录 deque 中存储的元素数量
     */
    private int size;

    public Deque(int capacity){
        // 由于使用 size，我们的 Deque 实现不浪费空间
